 ...
 * @author: fallsea
 * @version 1.0
 * @date: 2018年5月8日 上午9:16:00
 */
@MappedJdbcTypes({JdbcType.BIGINT})
@MappedTypes({Object.class})
public class LongTypeHandler extends BaseTypeHandler<Object> {
	
	private static Logger logger = LoggerFactory.getLogger(LongTypeHandler.class);

	@Override
	public Object getNullableResult(ResultSet resultSet, String arg1) throws SQLException {
		return resultSet.getLong(arg1);
	}
	...
	public Object getNullableResult(CallableStatement callableStatement, int arg1) throws SQLException {
		 return callableStatement.getLong(arg1);
	}
	...
	public void setNonNullParameter(PreparedStatement preparedStatement, int arg1, Object arg2, JdbcType arg3) throws SQLException {
		...
		if(StringHelper.isNotEmpty(arg2)){
			if(arg2 instanceof Long){
				...
				try {
					value = Long.parseLong(arg2.toString());
		...
		if(null==value) {
			preparedStatement.setNull(arg1, Types.BIGINT);
		}else {
			preparedStatement.setLong(arg1, value);
		}
	}
